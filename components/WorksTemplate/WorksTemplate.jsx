  ...
  return (
    <section {...GET_CLASSNAME}>
      ...
      <section className="detail_key_visual_wrap section_div is_black">
        <Visual dimm="Y" className="detail_key_visual" imgUrl={visualImgUrl} pageTitleData={visualChildren}>
      ...
      {/* S: custom 영역 */}
      <section className="custom_area section_div is_photo">{customChildren}</section>
      {/* E: custom 영역 */}

      {/* S: Sub Visual 영역 */}
      <Visual dimm="Y" className="detail_sub_visual_wrap section_div is_black" imgUrl={subVisualImgUrl}>
      ...
      <section className="detail_next_work_wrap section_div is_photo">
        ...
        <div>
          <Btn className="next_work_list" type="link" url={firstNextWork.pageUrl}>
            <BaseArticle
          ...
          <Btn className="next_work_list" type="link" url={secondNextWork.pageUrl}>
            <BaseArticle
          ...
          <Btn className="next_work_list" type="link" url={thirdNextWork.pageUrl}>
            <BaseArticle
