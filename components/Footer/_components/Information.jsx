...
const Information = ({ data, className }) => {
  if (!data) {
  ...
  return (
    <div className={className.warp}>
      ...
      {/* download_btn는 사용하지 않음 : <Btn className="download_btn" type="a" url={companyProfile.href} target="_blank">{companyProfile.title}</Btn> */}
    </div>
  );
};
