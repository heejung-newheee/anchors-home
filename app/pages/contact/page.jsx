    ...
    <main className="contact section_div is_photo">
      ...
      <Visual defaultId="scroll_main_visual" imgUrl={contact.imgUrl + contact.visual.img} alt={contact.visual.alt}>
        <section className="contact_cont_wrap">
          <DepthTitle depthLevel="1" blindOption="hidden">Anchors Contact Infomation</DepthTitle>

          {/* S: 말풍선 영역 */}
          <span className="wordbubble"><img src={contact.imgUrl + contact.visual.bubbleImg} alt={contact.visual.bubbleAlt} /></span>
          {/* E: 말풍선 영역 */}

          {/* S: content 영역 */}
          <div className="contact_address"><Description data={contact.visual.address} /></div>
