            ...
            <main>
                <dl>
                    ...
                    <dd>
                        ...
                        <p>Class, ID : 단어와 단어 사이에 하이픈을 사용한다. Ex) .our-works</p>
                        <p>image 내 파일 : 단어와 단어 사이에 하이픈을 사용한다. Ex) ico-our-works</p>
                    </dd>
                    ...
                    <dd>
                        ...
                        <div className="box">
                            <p>
                                .class &#123; <br/>모바일 해상도 미디어쿼리 <br/>&#125;<br/>
                                @include tablet &#123;<br/>
                                .class &#123; 태블릿 해상도 미디어쿼리 &#125;<br/>
                                &#125;<br/>
                                @include desktop &#123;<br/>
                                .class &#123; 데스크탑 해상도 미디어쿼리 &#125;<br/>
                                &#125;<br/>
                                @include wide &#123;<br/>
                                .class &#123; 와이드 데스크탑 해상도 미디어쿼리 &#125;<br/>
                                &#125;
                            </p>
                        </div>
                    </dd>
                    ...
                    <dt>Json Rule</dt>
                    <dd>
                        <p>Json파일은 해당 디렉토리에 가이드에서 제공하는 네이밍으로 파일명을 생성한다.</p>
